// linkSourceId mapping:
//   DANA  → 00000000-0000-0000-0000-000000000021
//   GoPay → 00000000-0000-0000-0000-000000000022
//   OVO   → 00000000-0000-0000-0000-000000000023
...
const REVIEWS = [
  {
    ...
    replied_at: new Date("2024-02-25T12:30:00Z"),
    app_version: "2.4.1",
    timestamp_unix: BigInt(1708855200),
    timestamp_formatted: "2024-02-25 10:00:00",
    source: "google_play",
    is_analyzed: false,
    linkSourceId: "00000000-0000-0000-0000-000000000021", // DANA
  },
  {
    id: "gp:AOqpTOE1_002",
    ...
    review_datetime: new Date("2024-02-26T08:15:00Z"),
    reply_content: "Senang mendengarnya! Terus gunakan aplikasi kami ya.",
    replied_at: new Date("2024-02-26T09:00:00Z"),
    app_version: "2.4.0",
    timestamp_unix: BigInt(1708935300),
  ...
  },
  {
    ...
    thumbs_up_count: 20,
    review_created_version: "2.4.1",
    review_datetime: new Date("2024-02-27T14:20:00Z"),
    reply_content: null,
    replied_at: null,
    app_version: "2.4.1",
    timestamp_unix: BigInt(1709043600),
  ...
  },
  {
    ...
    review_datetime: new Date("2024-02-24T11:45:00Z"),
    reply_content:
      "Maaf atas ketidaknyamanannya. Kami akan terus optimasi performanya.",
    replied_at: new Date("2024-02-24T15:00:00Z"),
    app_version: "2.3.9",
    timestamp_unix: BigInt(1708775100),
    timestamp_formatted: "2024-02-24 11:45:00",
    source: "google_play",
    is_analyzed: false,
    linkSourceId: "00000000-0000-0000-0000-000000000022", // GoPay
  },
  {
    id: "ap:12345678_005",
    ...
    thumbs_up_count: 8,
    review_created_version: "2.4.1",
    review_datetime: new Date("2024-02-28T09:10:00Z"),
    reply_content: "Terima kasih! Kami senang fitur top-up memudahkan Anda.",
    replied_at: new Date("2024-02-28T10:30:00Z"),
    app_version: "2.4.1",
    timestamp_unix: BigInt(1709111400),
  ...
  },
  {
    ...
    thumbs_up_count: 15,
    review_created_version: "2.4.1",
    review_datetime: new Date("2024-02-22T16:30:00Z"),
    reply_content: "Kami selalu siap membantu Anda!",
    replied_at: new Date("2024-02-22T17:00:00Z"),
    app_version: "2.4.1",
    timestamp_unix: BigInt(1708619400),
  ...
  },
  {
    ...
    thumbs_up_count: 6,
    review_created_version: "2.4.1",
    review_datetime: new Date("2024-02-23T20:10:00Z"),
    reply_content: null,
    replied_at: null,
    app_version: "2.4.1",
    timestamp_unix: BigInt(1708719000),
    timestamp_formatted: "2024-02-23 20:10:00",
    source: "google_play",
    is_analyzed: false,
    linkSourceId: "00000000-0000-0000-0000-000000000023", // OVO
  },
  {
    id: "ap:12345678_008",
    ...
    thumbs_up_count: 30,
    review_created_version: "2.4.0",
    review_datetime: new Date("2024-02-21T10:00:00Z"),
    reply_content: "Sip! Selamat menikmati layanan penuh kami.",
    replied_at: new Date("2024-02-21T11:00:00Z"),
    app_version: "2.4.0",
    timestamp_unix: BigInt(1708512000),
  ...
  },
  {
    ...
    thumbs_up_count: 4,
    review_created_version: "2.4.1",
    review_datetime: new Date("2024-02-20T12:00:00Z"),
    reply_content:
      "Terima kasih laporannya. Tim teknis kami sedang memperbaikinya.",
    replied_at: new Date("2024-02-20T14:30:00Z"),
    app_version: "2.4.1",
    timestamp_unix: BigInt(1708430400),
  ...
  },
  {
    ...
    thumbs_up_count: 10,
    review_created_version: "2.4.1",
    review_datetime: new Date("2024-02-20T15:00:00Z"),
    reply_content: null,
    replied_at: null,
    app_version: "2.4.1",
    timestamp_unix: BigInt(1708441200),
  ...
  for (const data of REVIEWS) {
    const review = await prisma.review.upsert({
      ...
      update: {
        ...
        linkSourceId: data.linkSourceId,
      },
      create: data,
    });
    console.log(`  ✓ Review: ${review.id} (${review.source})`);
  }
}

module.exports = { seedReviews, REVIEWS };
